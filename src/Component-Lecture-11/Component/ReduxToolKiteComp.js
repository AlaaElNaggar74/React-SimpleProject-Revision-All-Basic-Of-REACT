        ...
        <div className="container">
          <div className="row">
            <h1 className="my-5 text-center bg-danger py-3 ">
              Alaa El Naggar 72 Redux ToolKite
            </h1>
          </div>
        </div>
      </div>
...
export default ReduxToolKiteComp;

// import React, { useEffect, useState } from "react";
// import { useSelector, useDispatch } from "react-redux";
// // import { deposite, withdraw } from "./Redux/Actions/Bank-Action"; // to play react-redux
// import {
//   deposite,
//   withdraw,
// } from "../Component/ReduxToolKite/Slices/Bank-Slice"; // to play redux tool kite
...
//   return (
//     <div className="ReduxToolKiteComp">
//       <div className="container">
//         <div className="row">
